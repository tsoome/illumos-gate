...
static const struct smb_infospec {
	...
	{ .is_type = SMB_TYPE_SYSTEM,
		.is_manu = offsetof(smb_system_t, smbsi_manufacturer),
		.is_product = offsetof(smb_system_t, smbsi_product),
		.is_version = offsetof(smb_system_t, smbsi_version),
		.is_serial = offsetof(smb_system_t, smbsi_serial),
	},
	{ .is_type = SMB_TYPE_BASEBOARD,
		.is_manu = offsetof(smb_bboard_t, smbbb_manufacturer),
		.is_product = offsetof(smb_bboard_t, smbbb_product),
		.is_version = offsetof(smb_bboard_t, smbbb_version),
		.is_serial = offsetof(smb_bboard_t, smbbb_serial),
		.is_asset = offsetof(smb_bboard_t, smbbb_asset),
		.is_location = offsetof(smb_bboard_t, smbbb_location),
		.is_contc = offsetof(smb_bboard_t, smbbb_cn),
		.is_contsz = SMB_CONT_WORD,
		.is_contv = offsetof(smb_bboard_t, smbbb_cv)
	},
	{ .is_type = SMB_TYPE_CHASSIS,
		.is_manu = offsetof(smb_chassis_t, smbch_manufacturer),
		.is_version = offsetof(smb_chassis_t, smbch_version),
		.is_serial = offsetof(smb_chassis_t, smbch_serial),
		.is_asset = offsetof(smb_chassis_t, smbch_asset),
	},
	{ .is_type = SMB_TYPE_PROCESSOR,
		.is_manu = offsetof(smb_processor_t, smbpr_manufacturer),
		.is_version = offsetof(smb_processor_t, smbpr_version),
		.is_serial = offsetof(smb_processor_t, smbpr_serial),
		.is_asset = offsetof(smb_processor_t, smbpr_asset),
		.is_location = offsetof(smb_processor_t, smbpr_socket),
		.is_part = offsetof(smb_processor_t, smbpr_part),
	},
	{ .is_type = SMB_TYPE_CACHE,
		.is_location = offsetof(smb_cache_t, smbca_socket),
	},
	{ .is_type = SMB_TYPE_PORT,
		.is_location = offsetof(smb_port_t, smbpo_iref),
	},
	{ .is_type = SMB_TYPE_SLOT,
		.is_location = offsetof(smb_slot_t, smbsl_name),
	},
	{ .is_type = SMB_TYPE_MEMDEVICE,
		.is_manu = offsetof(smb_memdevice_t, smbmdev_manufacturer),
		.is_serial = offsetof(smb_memdevice_t, smbmdev_serial),
		.is_asset = offsetof(smb_memdevice_t, smbmdev_asset),
		.is_location = offsetof(smb_memdevice_t, smbmdev_dloc),
		.is_part = offsetof(smb_memdevice_t, smbmdev_part),
	},
	{ .is_type = SMB_TYPE_POWERSUP,
		.is_manu = offsetof(smb_powersup_t, smbpsup_manufacturer),
		.is_product = offsetof(smb_powersup_t, smbpsup_devname),
		.is_version = offsetof(smb_powersup_t, smbpsup_rev),
		.is_serial = offsetof(smb_powersup_t, smbpsup_serial),
		.is_asset = offsetof(smb_powersup_t, smbpsup_asset),
		.is_location = offsetof(smb_powersup_t, smbpsup_loc),
		.is_part = offsetof(smb_powersup_t, smbpsup_part),
	},
	{ .is_type = SMB_TYPE_BATTERY,
		.is_manu = offsetof(smb_battery_t, smbbat_manufacturer),
		.is_product = offsetof(smb_battery_t, smbbat_devname),
		/*
		 ...
		 */
		.is_location = offsetof(smb_battery_t, smbbat_loc),
	},
	{ .is_type = SMB_TYPE_FWINFO,
		.is_manu = offsetof(smb_fwinfo_t, smbfwii_mfg),
		.is_version = offsetof(smb_fwinfo_t, smbfwii_vers),
	},
	{ .is_type = SMB_TYPE_EOT }
};
