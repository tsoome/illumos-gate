...
pics/path/pathpath.o := CERRWARN += -_gcc13=-Wno-return-local-addr
pics/path/pathkey.o := CERRWARN += -_gcc10=-Wno-return-local-addr
pics/path/pathkey.o := CERRWARN += -_gcc13=-Wno-return-local-addr
pics/path/pathprobe.o := CERRWARN += -_gcc10=-Wno-return-local-addr
pics/path/pathprobe.o := CERRWARN += -_gcc13=-Wno-return-local-addr

# The code layout after macro expansion is upsetting gcc 12, silence it.
pics/sfio/sfdisc.o := CERRWARN += -_gcc13=-Wno-misleading-indentation
pics/sfio/sfstack.o := CERRWARN += -_gcc13=-Wno-misleading-indentation
