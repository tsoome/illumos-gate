	...
	tcam_entry_t *tcam_ptr)
{
	...
	fspec_key = flow_spec->uh.udpip4spec;
	fspec_mask = flow_spec->um.udpip4spec;
	...
	tcam_entry_t *tcam_ptr)
{
	...
	fspec_key = flow_spec->uh.udpip6spec;
	fspec_mask = flow_spec->um.udpip6spec;
	p_class_cfgp = (p_nxge_class_pt_cfg_t)&nxgep->class_config;
	...
	tcam_entry_t *tcam_ptr)
{
	...
	fspec_key = flow_spec->uh.tcpip4spec;
	fspec_mask = flow_spec->um.tcpip4spec;
	...
	tcam_entry_t *tcam_ptr)
{
	...
	fspec_key = flow_spec->uh.tcpip6spec;
	fspec_mask = flow_spec->um.tcpip6spec;
	...
	tcam_entry_t *tcam_ptr)
{
	...
	fspec_key = flow_spec->uh.ahip4spec;
	fspec_mask = flow_spec->um.ahip4spec;
	...
	tcam_entry_t *tcam_ptr)
{
	...
	fspec_key = flow_spec->uh.ahip6spec;
	fspec_mask = flow_spec->um.ahip6spec;
	...
	tcam_entry_t *tcam_ptr, tcam_class_t class)
{
	...
	fspec_key = flow_spec->uh.ip_usr_spec;
	fspec_mask = flow_spec->um.ip_usr_spec;
...
nxge_get_tcam_entry(p_nxge_t nxgep, flow_resource_t *fs)
{
	...
	tcam_entry_t	*tp;
	flow_spec_t	*fspec;
	tcpip4_spec_t 	fspec_key = { 0 };
	tcpip4_spec_t 	fspec_mask = { 0 };
	...
	case TCAM_CLASS_AH_ESP_IPV4:
	case TCAM_CLASS_SCTP_IPV4:
		fspec_key = fspec->uh.tcpip4spec;
		fspec_mask = fspec->um.tcpip4spec;
